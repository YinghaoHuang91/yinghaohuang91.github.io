...
## 写在最后
数字人或者虚拟人技术已经成为学术界和工业界的一个火热的方向。每年都有很多论文被顶级会议和期刊接受（在ToG过去四十多年所有发表五千多篇论文中，领域内经典论文[SMPL](https://ps.is.mpg.de/code/smpl)引用数量[位居第三](https://dl.acm.org/action/doSearch?fillQuickSearch=false&SeriesKey=tog&sortBy=cited)，而且还在快速增长中），各大科技巨头也都提供很好的工作岗位，同时这个新兴的领域也有很多打造个人品牌的机会。我很荣幸可以继续在这一令人兴奋且有光明前景的方向进行科研探索，并渴盼可以和持同样看法的其他人一起努力。我希望正在阅读这则招生通告的您就是这些人中的一员，并加入我们成为新团队的一份子。
